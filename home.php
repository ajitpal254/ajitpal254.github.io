...
<nav class="navbar navbar-expand-md navbar-light  sticky-top" id="navbar1">
  ...
  <ul class=" navbar navbar-nav">
      ...
      <button type="button" class="btn" style="font-weight: bold;text-decoration: none;"><a href="login.php">Log In</a>
    </button>
     <button type="button" class="btn" style="font-weight: bold; text-decoration: none;"><a href="signup.php">Sign Up</a></button>
...
<div id="contact" class="container " id="contact">
  <h1 class="text-center">Contact</h1><br><br>
...
<!-------------------------------Footer-------------------------->
<div class="footer">
<div class="container-fluid jumbotron " style="color:white;margin-bottom: 0px; background-color: #434D4A;">
<div class="container">  
<div class="row">
  <div class="col-md-3" >
  ...
  <div class="col-md-3">
    ...
    <a href="#" style="text-decoration: none; color: white;">Courses</a><br>
    <a href="#" style="text-decoration: none; color: white;">About Us</a><br>
    <a href="#" style="text-decoration: none; color: white;">Contact</a>
  </div>

  <div class="col-md-3">
    <h4>RESOURCES</h4>
    <a href="#" style="text-decoration: none; color: white;">Newsletters</a><br>
    <a href="#" style="text-decoration: none; color: white;">Certificates</a><br>
    <a href="#" style="text-decoration: none; color: white;">Examples</a><br>
    <a href="#" style="text-decoration: none; color: white;">Quiz</a>
  </div>
